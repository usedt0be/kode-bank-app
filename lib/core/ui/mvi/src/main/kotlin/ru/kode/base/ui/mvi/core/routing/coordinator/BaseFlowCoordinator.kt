package ru.kode.base.ui.mvi.core.routing.coordinator

import io.reactivex.disposables.CompositeDisposable
import io.reactivex.disposables.Disposable
import leakcanary.AppWatcher
import ru.kode.base.ui.mvi.core.routing.Route
import ru.kode.base.ui.mvi.core.routing.RouteContext
...
abstract class BaseFlowCoordinator1<Event, Params, Result>(private val scope: Scope) :
  ...
  final override fun finish(result: Result) {
    ...
    AppWatcher.objectWatcher.expectWeaklyReachable(this, "${this.javaClass.simpleName} coordinator is destroyed")
    AppWatcher.objectWatcher.expectWeaklyReachable(scope, "${scope.javaClass.simpleName} coordinator is destroyed")
  }
